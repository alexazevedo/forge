...
description: forge implementer, haiku rung — boilerplate, renames, docs, config, glue code, simple CRUD. Dispatched by forge:run with one ticket; not for open-ended exploration.
